...
class pageProcessor:
    '''
    Class with the business logic to split the even page and odd page to the different values expected by the Galileo ICD
    '''
...
class ubloxWordsList2GalileoICD:
    '''
    This class transforms a list of ublox words into a Galileo information.
    As a main method, it has:
        - ublox2Galileo, which transforms and stores the values
    And as "get" methods, the different Galileo pages information, as per Galileo ICD.
    '''
    def ublox2Galileo(self,ubloxList):
        ...
        self.__evenEvenOdd, self.__evenPagType, self.__wordType, self.__dataK, self.__evenTail, self.__evenGalileo = pageProcessor.processEvenPage(self.__evenPage)
        self.__oddEvenOdd, self.__oddPagType, self.__dataJ, self.__osnma, self.__SAR, self.__spare, self.__CRC, self.__reserved2, self.__oddTail, self.__oddGalileo = pageProcessor.processOddPage(self.__oddPage)
...
class testVectors2GalileoICD:
    '''
    This class is used to tranform the input Test Vectors provided to a commmon input.
    '''
