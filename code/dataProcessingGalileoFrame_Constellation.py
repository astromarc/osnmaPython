...
word_types_sequence = [(2,), (4,), (6,), (7,9), (8,10), (0,17,18), (0,19,20), (0,16), (0,), (0,), (1,), (3,), (5,), (0,), (0,16)] #Compatibility with SiS ICD issue 2 and issue 1


class svNavMessage:
    '''
    class that encapsulates the Galileo Sub-Frame and Frame sequencing as well as SubFrame and Frame storing.
    '''
...
class svConstellation:
    '''
    High level class that stores the information about the Space Vehicles SubFrames (via associated class), DSM Messages (via associated class) and Space Vehicles authentication status (including cross authentication)
    '''
